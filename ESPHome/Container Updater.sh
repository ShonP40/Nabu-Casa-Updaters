...
printf "\nWelcome to the ESPHome Container Updater!\n\n"
...
currentVer=$(docker exec -it esphome esphome version | grep -Po "(\d+\.)+\d+")
...
then
    ...
    printf "\n\nESPHome has been updated and restarted successfully!\n\n"
    printf "You may now delete your old ESPHome image safely\n\n"
else
